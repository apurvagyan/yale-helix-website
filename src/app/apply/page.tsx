      ...
      <div className={ui.container}>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-text-muted">
            Thank you for your interest in Yale Helix. Applications for the 2026&ndash;2027 fellow
            cohort closed on September 13 and we are no longer accepting submissions. If you already
            applied, we have your application and will be in touch.
          </p>
          <p className="mx-auto mt-4 max-w-xl text-text-muted">
